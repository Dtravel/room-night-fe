...
export const stripePaymentBooking = (reservationId: string, billingDetail?: any) => {
...
export const getPricesBooking = (data: BookingPricesProps, cancelParams?: any) => {
  let optionsApi: any = {
    method: 'post',
...
export const getPricesManualBooking = (reservationId: string, data: ManualPriceBookingProps, cancelParams?: any) => {
  let optionsApi: any = {
    method: 'post',
...
export const updateManualBookingOrder = (reservationId: string, data: ManualBookingDataProps) => {
  return api({
    method: 'post',
