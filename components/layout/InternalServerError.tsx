...
const InternalServerError: React.FC<Props> = () => {
  ...
  return (
    <div className={'flex justify-center items-center min-h-screen'}>
      <div className='font-inter-700 text-240-290 xl:text-400-484 text-neutral-100 absolute z-0 max-w-[100vw] overflow-hidden flex items-center justify-center'>Oops!</div>
      <div className={'text-center z-10'}>
        <h1 className='font-inter-600 text-48-48 md:text-64-64 xl:text-88-88 mb-[16px] md:mb-[24px] tracking-[-0.04em] xl:tracking-[-0.035em] text-neutral-900 px-[16px] md:px-0'>Well, this is unexpected…</h1>
        <p className='mb-[40px] text-neutral-600 font-inter-400 text-20-28 md:text-24-36 px-[16px] md:px-0'>Please try again later.</p>
